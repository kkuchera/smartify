...
import com.example.smartify.devices.DevicesActivity;
...
public class GeofenceReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        mContext = context;
        DevicesRepository repository = Injection.provideDevicesRepository(context);
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
                for (Geofence geofence: triggeringGeofences) {
                    repository.open(Integer.valueOf(geofence.getRequestId()));
                }
            }
        } else {
            Log.e(TAG, mContext.getString(R.string.geofence_transition_invalid_type,
                    geofenceTransition));
        }
    }
     ...
     * If the user clicks the notification, control goes to the DevicesActivity.
     */
    private void sendNotification(String notificationDetails) {
        // Create an explicit content Intent that starts the devices Activity.
        Intent notificationIntent = new Intent(mContext, DevicesActivity.class);
